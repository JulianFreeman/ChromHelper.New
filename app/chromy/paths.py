...
from app.common.utils import get_with_chained_keys, path_not_exist
...
def get_browser_exec_path(browser: str, missing_ok: bool = False) -> str | None:
    ...
    if missing_ok or (not path_not_exist(exec_path)):
        return exec_path
...
def get_browser_data_path(browser: str, missing_ok: bool = False) -> str | None:
    ...
    if missing_ok or (not path_not_exist(data_path)):
        return data_path
